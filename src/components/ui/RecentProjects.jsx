...
export default function RecentProjects({ isDarkMode }) {
  return (
    <div className={`flex flex-col w-full max-w-4xl backdrop-blur-xl border mt-2 rounded-md p-3 shadow-4xl transition-colors duration-300 ${isDarkMode ? 'bg-white/10 border-white/20' : 'bg-white border-gray-200'}`}>
